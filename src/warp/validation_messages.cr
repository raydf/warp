module Warp::Validation
  ...
  struct Messages
    ...
    def self.filled?(field_name : String)
    ...
    def self.sized?(field_name : String, field_min_size : NUMERIC_TYPES, field_max_size : NUMERIC_TYPES? )
      str = String.build do |str|
        if field_max_size
    ...
    def self.format?(field_name : String, format_message : String )
